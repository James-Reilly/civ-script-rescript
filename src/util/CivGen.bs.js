...
var data = {
  hd: {
    detail: "The Founding Fathers perk allows the Americans to earn Government Legacy bonuses twice as quickly, allowing players to benefit more from sticking with a single government type over a large number of turns. America\xe2\x80\x99s unique unit is the P-51 Mustang, a modern-era fighter jet with bonuses to flight range, experience, and attack vs. fighter aircraft. The Mustang is best suited for eliminating enemy fighter jets. America\xe2\x80\x99s unique infrastructure, the Film Studio, provides a culture bonus, adds extra slots for Citizens and Great Works of Music, and earns Great Artist and Great Musician points each turn. It also creates +100% Tourism pressure toward other civilizations, encouraging tourists to visit the American city instead.Teddy Roosevelt, the 26th President of the United States, leads the Americans. Because of his unique agenda, Big Stick Policy, Teddy dislikes warring civilizations and civilizations that bully city-states on his continent. His unique leader ability, the Roosevelt Corollary, grants Combat Strength bonuses to units on the American continent, and appeal bonuses to tiles in a city with a National Park. The Corollary also allows America to build the Rough Rider unit \xe2\x80\x94 as long as the Rifling Technology is researched \xe2\x80\x94 which generates Culture with each kill and boasts a Combat Strength bonus when fighting on hills. Teddy\xe2\x80\x99s bonuses are especially advantageous in the early game, helping the player expand across his home continent with ease.",
    name: "American",
  ...
  tl: {
    hd: {
      detail: "The Last Prophet perk automatically grants Arabia the final Great Prophet, which will automatically found a Religion in a holy site or Stonehenge wonder. It\xe2\x80\x99s a powerful perk, but difficult to plan around, since it\xe2\x80\x99s impossible to know when it will activate. Arabia\xe2\x80\x99s unique unit, the Mamluk, is a Medieval era heavy cavalry unit that automatically restores full health at the end of each turn, allowing players to utilize it more aggressively. Arabia\xe2\x80\x99s unique infrastructure, the Madrasa, provides bonuses to Science and Housing, adds an extra Citizen slot, and earns Great Scientist points each turn. The Madrasa also provides additional Faith based upon Campus adjacency bonuses.Saladin, the first Sultan of Egypt and Syria, acts as the Arabian leader. Saladin\xe2\x80\x99s unique agenda, Ayyubid Dynasty, causes Saladin to like civilizations with his Worship building, while disliking civilizations following other Religions and civilizations waging war on followers of his Religion. His unique leader ability, Righteousness of the Faith, reduces cost for Worship buildings, and provides bonuses to Culture, Faith, and Science from those buildings. Many of Arabia\xe2\x80\x99s bonuses and abilities are tied to Religion and Science, meaning that players may find it easier to achieve Religious or Scientific victory with Saladin.",
      name: "Arabian",
      leaderName: "Saladin",
    ...
    tl: {
      ...
      tl: {
        hd: {
          detail: "The Legend of the Five Suns perk allows the player to sacrifice builder units in order to speed up construction of Districts within cities. The Aztecs\xe2\x80\x99 unique unit, the Eagle Warrior, features a bonus to anti-cavalry units, and may capture defeated enemy units and convert them into Builder units for the Aztecs. This synergizes with the Aztecs\xe2\x80\x99 culture perk, allowing the culture to steadily sacrifice Builder units to speed progress. The Aztecs\xe2\x80\x99 unique infrastructure is Tlachtli, which can be built into the Entertainment Complex, and provides Amenities, Faith, and Great General points each turn.Montezuma, the fifth emperor of Tenochtitlan, leads the Aztecs. Montezuma\xe2\x80\x99s unique agenda, Tlatoani, causes him to like civilizations with the same luxury resources as the Aztecs, while disliking civilizations with different luxury resources. His unique leader ability, Gifts for the Tlatoani, causes luxury resources in Aztec territory to give Amenities to two extra cities. In addition, military units receive bonuses to Combat Strength for each different luxury resource improved in Aztec territory. Most of the Aztecs\xe2\x80\x99 bonuses and abilities are tied to military power, and expanding the Aztec empire early in the game.",
          name: "Aztec",
        ...
        tl: {
          hd: {
            detail: "The Amazon perk provides bonuses to Districts and neighborhoods built adjacent to Rainforest tiles.  The Brazilians\xe2\x80\x99 unique unit is the Minas Geraes, an Industrial era naval unit with improved ranged combat and defense values which requires players to first invest in the Nationalist Civic. The Brazilians\xe2\x80\x99 unique infrastructure, the Carnival District, provides Amenities from Entertainment to the parent city, and can house the Zoo and Stadium buildings. The Carnival also provides extra Amenities while being built, and completion earns Great Engineer, Artist, Writer, and Musician points.Pedro II, the final emperor of Brazil, acts as the Brazilian leader. Pedro\xe2\x80\x99s unique agenda, Patron of the Arts, drives Pedro to pursue Great People while disliking civilizations that attempt to pursue Great People as well. His unique leader ability, Magnanimous, allows him to retain 20% of Great Person points used after recruiting or patronizing a Great Person. This synergizes well with the Carnival District, allowing Brazil to recruit several Great People across different disciplines and eras. Brazil\xe2\x80\x99s focus on Great Leaders makes it a candidate for Cultural victory.",
            name: "Brazilian",
            leaderName: "Pedro II",
            perk: "Perk: Amazon",
          ...
          tl: {
            hd: {
              detail: "Canada\xe2\x80\x99s unique perk is the Four Faces of Peace, which protects you from Surprise Wars, but consequently requires that you don\xe2\x80\x99t declare a Surprise War, either. Because of your peace, Canada earns 1% of its Tourism as Diplomatic Favor, which doesn\xe2\x80\x99t do much in the early game. Later on, though, once you have enough infrastructure, the extra boost means Canada has a greater say at the World Congress table. Canada\xe2\x80\x99s unique infrastructure, Ice Hockey Rink, adds an Amenity and boosts your Culture depending on how many Tundra and Snow tiles surround it. Build this structure next to Tundra tiles, not on them, for the best bonus. Later in the game, you can further your Culture from these tiles by building Stadiums next to them.The unique unit, the Mountie, lends itself to the tourist mindset as well, allowing you to build National Parks for 400 Production of 1,600 Gold, rather than the usual requirement of 1,600 Faith. Heading up Canada is Wilfrid Laurier, who has the unique agenda Canadian Expeditionary Force. Basically, it means that you\xe2\x80\x99ll want to participate in Emergencies and Competitions whenever possible. Doing so will further your Diplomatic Influence, which should already be high with Canada\xe2\x80\x99s perk. Wilfrid\xe2\x80\x99s leader bonus is The Last Best West, which allows you to build Farms on Tundra tiles. Tundra tiles also cost half as much Gold to purchase and produce twice as many resources.",
            ...
            tl: {
              ...
              tl: {
                ...
                tl: {
                  ...
                  tl: {
                    hd: {
                      detail: "The Iteru perk speeds construction of Districts and Wonders adjacent to rivers, and allows the construction of Districts and Wonders upon Floodplain tiles. The Egyptians\xe2\x80\x99 unique unit, the Maryannu Chariot Archer, is a mounted Ancient era ranged unit that gains movement bonuses when starting turns on open terrain. The Egyptians\xe2\x80\x99 unique infrastructure is the Sphinx, a tile improvement that provides bonuses to Faith and Culture, and can only be built on Egyptian-controlled Floodplains tiles. The Sphinx provides extra bonuses if placed next to a Wonder or if the Natural History Civic has been researched.Cleopatra, the final pharaoh of Ptolymaic Egypt, leads Egypt.  Because of Cleopatra\xe2\x80\x99s unique agenda, Queen of the Nile, she favors civilizations with strong militaries. Her unique leader ability, Mediterranean\xe2\x80\x99s Bride, provides bonuses to trade routes; specifically, Egypt earns extra Gold for trade routes it starts, and bonus Food and Gold for other civilizations\xe2\x80\x99 trade routes to Egypt. Egypt is best equipped to flourish as a trade state, and thus is suited for Score or Domination Victories. The Chariot Archer also provides Egypt with an early combat advantage.",
                      name: "Egyptian",
                          ...
                          tl: {
                            ...
                            tl: {
                              ...
                              tl: {
                                ...
                                tl: {
                                  hd: {
                                    detail: "The Gran Colombian civilization is all about domination. Its unique perk, Ej\xc3\xa9rcito Patriota, is simple but powerful, granting +1 Movement to all of your units. It also allows you to promote a unit without ending its turn. In place of Cavalry, the Gran Colombian civilization gets the Llanero. These units are cheap to maintain and gain significant bonuses when placed next to each other. You\xe2\x80\x99ll want to train up small armies of these units, sending them out in batches. This civ\xe2\x80\x99s unique infrastructure, the Hacienda, isn\xe2\x80\x99t very powerful, offering slight boosts in Gold, Production, Housing, and Food. Worse, you can\xe2\x80\x99t use the tile improvement until the Renaissance Era.Leading the Gran Colombian Empire is Sim\xc3\xb3n Bol\xc3\xadvar, who wants to focus on promoting units with Encampments, thanks to his agenda, Carabobo. His leader bonus is Campa\xc3\xb1a Admirable, which grants you a Comandante General, a unique type of Great Person, at the start of each new era.",
                                    name: "Gran Colombian",
                                    leaderName: "Sim\xc3\xb3n Bol\xc3\xadvar",
                                    perk: "Perk: Ej\xc3\xa9rcito Patriota",
                                    unit: "Unit: Llanero",
                                    infra: "Infrastructure: Hacienda"
                                  },
                                  tl: {
                                    hd: {
                                      detail: "The Plato\xe2\x80\x99s Republic perk grants the Greeks an extra wildcard policy slot, regardless of government type. The unique Greek unit is the Hoplite, an Ancient era unit which gains a significant bonus to Combat Strength when adjacent to another Hoplite unit. The unique Greek infrastructure, the Acropolis, is a District which grants Culture bonuses for adjacent Wonders and District tiles, and earns Great Writer, Artist, and Musician points each turn. The Acropolis also receives a significant Culture bonus when built adjacent to the City Center, and requires the Drama and Poetry Civic to build.The Greeks are led by one of two famous figures; Pericles, an Athenian general between the Persian and Peloponnesian Wars, is the first. Pericles\xe2\x80\x99 unique agenda, Delian League, leads him to dislike civilizations that are directly competing for the same city-state. His unique leader ability, Surrounded by Glory, provides a significant Culture bonus for any city-states that Pericles is Suzerain of. Pericles is best suited for Cultural victories via establishing trade routes and engaging city-states.Gorgo, the Spartan queen in the mid-400s, B.C., is the second Greek leader. Gorgo\xe2\x80\x99s unique agenda, With Your Shield or On It, causes her to avoid surrendering items in peace deals, while disliking civilizations that have surrendered or have never engaged in war. Her unique leader ability, Thermoplyae, provides a Culture bonus upon defeating enemy units. Gorgo is uniquely suited for Cultural victories via military strength and defense.",
                                      name: "Greek",
                                      leaderName: "Pericles",
                                      perk: "Perk: Plato\xe2\x80\x99s Republic",
                                      unit: "Unit: Hoplite",
                                    ...
                                    tl: {
                                      ...
                                      tl: {
                                        hd: {
                                          detail: "The Hungarian Empire is focused on domination, mainly because of its leader\xe2\x80\x99s ability, Raven King. Matthias Corvinus\xe2\x80\x99 unique ability grants +2 Movement and +5 Combat Strength to units you\xe2\x80\x99ve levied from a city-state. You can also upgrade these units at a 75% discount. The unique unit Black Army works into this theme, as well, earning a buff in Combat Strength for each levied unit you control. The civ ability, Pearl of the Danube, isn\xe2\x80\x99t directly focused on domination, though it\xe2\x80\x99s still powerful. It\xe2\x80\x99s simple, offering an extra 50% Production for districts and buildings built across a river from a City Center.For a unit, you have access to the Husz\xc3\xa1r instead of Cavalry. These units are slightly more expensive than standard Cavalry (five Gold more) but come with significant buffs in the Combat Strength department. In particular, the Husz\xc3\xa1r gain +3 Combat Strength for every active Alliance you have. Hungary\xe2\x80\x99s unique infrastructure is the Thermal Bath, which provides two Amenities and two Production to all City Centers within six tiles, as well as +3 Tourism.",
                                          name: "Hungarian (Gathering Storm)",
                                          leaderName: "Matthias Corvinus",
                                          perk: "Perk: Pearl of the Danube",
                                          unit: "Unit: Husz\xc3\xa1r",
                                          infra: "Infrastructure: Thermal Bath"
                                        },
                                        tl: {
                                          hd: {
                                            detail: "The Incan Empire wants to play things safe above all else. Its civ ability is Mit\xe2\x80\x99a, which allows Citizens to work on Mountain tiles. Mountain tiles also provide +2 Production and +1 Food for each adjacent Terrace Farm. Speaking of which, the Terrace Farm is unique to the Incans. It\xe2\x80\x99s a tile improvement that you can build on Grassland Hills, Plains Hills, Desert Hills, and Volcanic Soil, offering +1 Food, +0.5 Housing, and +2 Production for each adjacent Aqueduct. The unique unit is the Warak\xe2\x80\x99aq, which replaces Skirmishers. These units have higher Ranged Strength and can make an additional attack each turn.Leading the empire is Pachacuti, who likes to settle near mountains and wants to be left alone with them, thanks to his agenda, Sapa Inca. His leader bonus is Qhapaq \xc3\x91an, which grants +1 Food to Domestic Trade Routes for every Mountain tile in the origin city. Later in the game, you can also unlock a tile improvement of the same name, allowing units to move between two of them for a cost of two Movement.",
                                            name: "Incan (Gathering Storm)",
                                            leaderName: "Pachacuti",
                                            perk: "Perk: Mit\xe2\x80\x99a",
                                            unit: "Unit: Warak\xe2\x80\x99aq",
                                            infra: "Infrastructure: Terrace Farm"
                                          },
                                          tl: {
                                            hd: {
                                              detail: "The Dharma perk means that all Indian-controlled cities gain the follower beliefs of all Religions practiced within. The unique Indian unit is the Varu war elephant, a Classical-era mounted unit that stacks and significantly reduces Combat Strength of adjacent enemy units. The unique Indian infrastructure, the Stepwell, is a tile improvement that cannot be built on hills, or adjacent to another Stepwell. The Stepwell provides bonuses to Housing and Food, with extra bonuses for Food if built adjacent to a farm, and for Faith if built adjacent to a Holy Site. The Varu and Stepwell work well together to progress quickly in the early game, either by militaristic conquest or building a strong religious base.Mohandas Gandhi, the spearhead of the Indian Independence Movement in the late 1800s and early 1900s, acts as the Indian leader. Due to Gandhi\xe2\x80\x99s unique agenda, Peacekeeper, he avoids wars, and prefers peaceful civilizations to warmongering civilizations. His unique leader ability, Satyagraha, provides a significant bonus to Religion for each civilization he meets that has founded a Religion (unless that civilization is at war with the Indians), and incurs Happiness penalties upon civilizations at war with the Indians. The Indians are naturally suited for Religious victory, with the Dharma perk and the Satyagraha ability working together to spread Gandhi\xe2\x80\x99s Religion across the map.India\xe2\x80\x99s second leader, Chandragupta, is new in the Civ VI expansion, Rise and Fall. His unique ability, Arthashastra, allows him to declare a war of expansion after earning the \xe2\x80\x9cMilitary Training\xe2\x80\x9d Civic. Chandragupta\xe2\x80\x99s units will also gain significant bonuses for the first 10 turns after declaring a war of expansion. Maurya Empire encourages Chandragupta to conquer nearby cities and befriend civilizations that are distant. Those playing either with or against Chandragupta will notice that he\xe2\x80\x99s built as the antithesis of Gandhi \xe2\x80\x94 far more warlike and territorial. Players should use extremely aggressive tactics in the early game as Chandragupta to maximize his bonuses in expansive wars.",
                                              name: "Indian",
                                              leaderName: "Gandhi",
                                              perk: "Perk: Dharma",
                                              unit: "Unit: Varu",
                                            ...
                                            tl: {
                                              ...
                                              tl: {
                                                hd: {
                                                  detail: "The Indonesian Empire doesn\xe2\x80\x99t force you into one specific victory path, trading synergy for raw power with abilities. The civ ability Great Nusantara gives a +0.5 adjacency bonus for Coast and Lake tiles with a Holy Site, Campus, Industrial Zone, and/or Theater Square district built next to them. Similarly, Entertainment Complexes provide +1 Amenity if they\xe2\x80\x99re placed adjacent to a Coast or Lake tile. You\xe2\x80\x99ll be taking advantage of those tiles a lot, too, thanks to the Jong unique unit. These naval powerhouses have higher Movement compared to the standard Frigate, and come with a Combat Strength boost when in formation, to boot. The Kampung tile improvement is one of the few you can build on water, offering +1 Production, +1 Housing, +1 Food for adjacent Fishing Boats, and +1 Tourism for every bonus Food.  You can get an additional +1 boost to Housing and Production with the Mass Production and Civil Engineering technologies, respectively.At the helm is Gitarja, who has the leader agenda Archipelagic State. Basically, she dislikes civs with multiple cities on small islands. Her leader bonus is Exalted Goddess of the Three Worlds, which offers multiple buffs for Religious units. With it, you can purchase naval units with Faith, Religious units don\xe2\x80\x99t have to pay movement costs to embark or disembark, and City Centers gain +2 Faith if they\xe2\x80\x99re adjacent to a Coast or Lake.",
                                                  name: "Indonesian",
                                                  leaderName: "Gitarja",
                                                ...
                                                tl: {
                                                  ...
                                                  tl: {
                                                    ...
                                                    tl: {
                                                      ...
                                                      tl: {
                                                        hd: {
                                                          detail: "Korea is a scientific powerhouse with its Three Kingdoms perk. Mines receive extra science when placed near Korea\xe2\x80\x99s unique district, Seowon. Farms also gain bonus food with that adjacency. On their own, Seowon provide massive bonuses to science, and must be built on hills and replace traditional campuses. The Hwacha, Korea\xe2\x80\x99s unique combat unit, is a Renaissance-Era ranged attacker. It is are far more powerful than its contemporaries, but at the cost of attacking and moving within the same turn.Seondeok was an influential leader specializing as a patron of arts and culture during her reign. As such, her special ability, Hwarang, provides an additional 10-perecent bonus to culture and science in cities with an established governor. Cheomseongdae, Korea\xe2\x80\x99s historic agenda, reflects this as well. Seondeok will maintain strong relationships with civs that pursue science, and will spurn those that don\xe2\x80\x99t. Because of Seondeok\xe2\x80\x99s unique powers, Korea is a one-track civilization that can leverage massive research bonuses for an early tech victory.",
                                                        ...
                                                        tl: {
                                                          ...
                                                          tl: {
                                                            ...
                                                            tl: {
                                                              ...
                                                              tl: {
                                                                hd: {
                                                                  detail: "The Mapuche are a versatile civilization, focusing on combat and culture. Toqui, the Mapuche ability, grants additional combat experience to units trained in cities with a Governor, and a massive combat bonus when fighting against a civilization in its Golden Age. Malon Raiders are a unique Renaissance Era unit that excels at defending territory close to home. If you\xe2\x80\x99re positioned well, Chemamull can help boost culture production, offering a bonus that scales with a tiles appeal and boosts tourism in latter eras.Lautaro led his people against the Spanish when he was just a teenager, but he was a brilliant commander and a talented general despite his age. His ability, Swift Hawk, can demoralize a foe with ease. If a Mapuche unit defeats an enemy unit inside the borders of a city, that city will take a staggering hit to loyalty, potentially opening it up for capture. As the leader of a resistance against Spanish colonizers, Lautaro\xe2\x80\x99s Spirit of Tucapel encourages him to keep loyalty high in his civilization and distrust those who don\xe2\x80\x99t do the same. Successful Mapuche tactics will hinge on defense, protecting your core cities while organizing targeted strikes to dismantle your enemies. Given the powerful bonus against prosperous civs, the Mapuche are also somewhat opportunistic, but can easily topple a far stronger civilization with careful planning.",
                                                                ...
                                                                tl: {
                                                                  ...
                                                                  tl: {
                                                                    ...
                                                                    tl: {
                                                                      ...
                                                                      tl: {
                                                                        hd: {
                                                                          detail: "Egypt\xe2\x80\x99s great rival to the south the Nubian Empire will have a strong and wealthy start due to the Ta-Seti perk, which gives all ranged units 50% more experience and a 50% production bonus, in addition to extra gold and production from mines over luxury and strategic resources, respectively. The P\xc3\xadtati Archer is a brutal (maybe even overpowered?) replacement for the standard archer, with more strength and one additional movement in exchange for a slightly higher production cost. The Nubian Pyramids tile improvement can only be built on desert or flood plains, adding faith and various other yields depending on adjacent districts, encouraging careful city planning to get the most out of them.Aminatore was Kandake of the Nubian people around the turn of the 1st century CE. Famous for leading a period of great construction, her City Planner agenda means that she tries to have as many districts as possible in her cities, and likes other players that do the same. Her unique ability, Kandake of Mero\xc3\xab, reflects this by providing a 20% production boost toward building districts, with an additional 20% added on in cities with a Nubian Pyramid adjacent to the city center. Nubia\xe2\x80\x99s abilities lend themselves to a very strong start, either focusing on conquest with its proficiency in ranged combat, or on domestic affairs with its ability to quickly build high-yield cities.",
                                                                          name: "Nubian",
                                                                          leaderName: "Aminatore",
                                                                          perk: "Perk: Ta-Seti",
                                                                          unit: "Unit: P\xc3\xadtati Archer",
                                                                          infra: "Infrastructure: Nubian Pyramid"
                                                                        },
                                                                        tl: {
                                                                          hd: {
                                                                            detail: "Exclusive to Gathering Storm, the Ottoman Empire is focused on war above all else. Its civ ability is Great Turkish Bombard, which grants +50% Production toward Siege units. Siege units also gain +5 Combat Strength against districts, and capturing a city doesn\xe2\x80\x99t cause it to lose any Population. Cities that you\xe2\x80\x99ve captured, not founded, also contribute +1 Amenity and +4 Loyalty each turn. You don\xe2\x80\x99t just have to conquer cities on land, either. With the Barbary Corsair unit, you can take the fight to the seas. These naval units replace the Privateer Corsair, with a lower Production cost and lower maintenance. Additionally, Barbary Corsairs doesn\xe2\x80\x99t use Movement to perform a coastal raid. The Grand Bazaar building replaces the Bank, offering the same boost to Gold and Citizenship, as well as a Great Merchant point each turn. Additionally, the Grand Bazaar gathers an extra Strategic Resource for each type the city has improved, as well as one Amenity for every Luxury Resource.Suleiman, the leader of the Ottoman Empire, is all about Happiness and Loyalty thanks to his Lawgiver agenda. His leader bonus is Grand Vizier, which allows you to recruit a unique Governor. Ibrahim is a diplomat who specializes in influencing the military operations of foreign powers. Additionally, he\xe2\x80\x99s the only Governor in the game that you can assign to another civ\xe2\x80\x99s Capital. Grand Vizier also allows you to construct Janissary units, which replace the Musketman unit. These units have a lower Production cost, higher Combat Strength, and start with a free promotion. Unfortunately, though, you can only train them in cities with two or more Population, and you have to subtract one from that number if training in a city founded by the Ottomans.",
                                                                          ...
                                                                          tl: {
                                                                            hd: {
                                                                              detail: "The Satrapies perk helps Persia build up a strong, internal economy early on, providing an extra trade route on unlocking Political Philosophy, adding gold and culture yields to domestic trade routes, and upgrading roads one more level than where they would otherwise be at any given moment. Persia\xe2\x80\x99s unique unit, the Immortal, replaces the swordsman: It is slightly less powerful, but a ranged attack instead of melee. Be sure to bring Warriors or cavalry units along with them to conquer cities in the early game, since they don\xe2\x80\x99t have a melee attack option. The Pairidaeza (or \xe2\x80\x9cparadise garden\xe2\x80\x9d) is a unique Persian tile improvement that adds culture, gold, and appeal, plus additional culture and gold depending on adjacent districts.Cyrus the Great founded the Achaemenid Empire in the 6th century BCE, to that point that largest empire in world history. His Opportunist agenda means that Cyrus likes leaders that spring Surprise Wars, and doesn\xe2\x80\x99t care about those that don\xe2\x80\x99t. Cyrus\xe2\x80\x99 unique bonus, Fall of Babylon, grants his units an extra +2 movement for the first 10 turns after declaring a Surprise War. Occupied cities don\xe2\x80\x99t suffer any reduction to their yields, and War Weariness is reduced as if it were a Formal War instead. Persia\xe2\x80\x99s bonuses to internal trade routes and roads makes them a very independent civ, which means they have even fewer consequences to worry about when declaring wars, making them a strong choice for the Domination victory, although their cultural production is good as well.",
                                                                              name: "Persian",
                                                                              leaderName: "Cyrus",
                                                                              perk: "Perk: Satrapies",
                                                                              unit: "Unit: Immortal",
                                                                            ...
                                                                            tl: {
                                                                              hd: {
                                                                                detail: "The Phoenician Empire starts with a Eureka Moment, automatically unlocking the Writing technology thanks to its civ ability, Mediterranean Colonies. The perk also grants full Loyalty to cities within the same continent as the Phoenician Capital and +2 Movement to Settlers. The Phoenician Empire is all about expansion, on land and on sea. For the latter, you\xe2\x80\x99ll need the Cothon district, which replaces the Harbor. It\xe2\x80\x99s mostly the same, just with a significantly lower Production cost and a Production bonus toward naval units and Settlers in the city. Out of this district, you can send a Bireme, a naval unit that replaces the Galley. Over the Galley, the Bireme has higher Combat Strength and Movement, plus it protects friendly Traders within four tiles (so long as they\xe2\x80\x99re on a water tile).Dido leads the Phoenician Empire, and she has the agenda Sicilian Wars. She likes civs that settle inland, leaving coastal cities for the Phoenicians. Her leader ability, Founder of Carthage, allows you to use the Move Capital project to move your Capital to any city with a Cothon. It also grants you +1 Trade Route capacity after you\xe2\x80\x99ve constructed a Government Plaza, as well as +50% Production toward districts in a city with a Government Plaza.",
                                                                              ...
                                                                              tl: {
                                                                                hd: {
                                                                                  detail: "The Golden Liberty perk allows the player to aggressively expand by triggering a \xe2\x80\x9cculture bomb\xe2\x80\x9d (claiming surrounding foreign tiles, even controlled by another player) every time they build a Fort or Encampment District. One of their military policy slots is also replaced with a wildcard instead, giving more flexibility. The Sukiennice is an upgrade over the standard Market building, adding a bonus of four gold to domestic trade routes and two production to international. Winged Hussars are a powerful, unique heavy cavalry unit that don\xe2\x80\x99t replace anything, and are unlocked with the Mercenaries civic. Hussars ignore zone of control and push back enemies that take more damage than they dish out, making them excellent for controlling the battlefield.Jadwiga ruled Poland in the 14th century as its first female monarch, famous for unifying the country\xe2\x80\x99s pagans under the Catholic church. Her agenda, Saint, means that she simply tries to accumulate faith and likes other civs that do the same. Her unique ability, Lithuanian Union, reflects that piety with a bonus to Holy Relics, greater adjacency bonuses from Holy Site Districts, and culture bombs from the Polish civ\xe2\x80\x99s special ability cause the assaulted city to convert to Jadwiga\xe2\x80\x99s religion. Poland\xe2\x80\x99s abilities are generally pretty flexible, but Jadwiga\xe2\x80\x99s perks mean you\xe2\x80\x99ll want a religion to help out. The early wildcard policy slot is especially helpful toward that end, allowing you to start accumulating Great Prophet points before most other civs.",
                                                                                  name: "Polish",
                                                                                  leaderName: "Jadwiga",
                                                                                      ...
                                                                                      tl: {
                                                                                        ...
                                                                                        tl: {
                                                                                          ...
                                                                                          tl: {
                                                                                            ...
                                                                                            tl: {
                                                                                              hd: {
                                                                                                detail: "Sweden can easily achieve a Cultural or Diplomatic victory with the right focus. Its civ ability is Nobel Prize, which awards +50 Diplomatic Favor for each Great Person you recruit. Additionally, you\xe2\x80\x99ll earn a Great Engineer point from Factories and a Great Scientist Point from Universities for specific recruits. Regardless of whether you\xe2\x80\x99re playing as Sweden or not, if it\xe2\x80\x99s present in the game, there are three unique World Congress competitions during the Industrial Era. The Carolean unit replaces the Pike and Shot unit, earning a boost to Combat Strength for each point of unused Movement. They also have a Movement speed of three versus two as well as a lower maintenance cost. The Open-Air Museum tile improvement offers +2 Loyalty each turn, as well as +2 Culture and Tourism for each type of terrain that you found a city on.The Bibliophile agenda intrigues Kristina, the Swedish leader, to gather as many Great Works as possible. Through her leadership ability, Minerva of the North, she automatically themes buildings and wonders with all of their Great Work slots filled. Kristina is capable of building the Queen\xe2\x80\x99s Bibliotheque building, where she\xe2\x80\x99d be awarded two Great Writer, Great Artist, and Great Musician points per turn and two slots each for Great Works of Writing, Great Works of Art, and Great Works of Music. It\xe2\x80\x99s a significant number of buffs. ",
                                                                                              ...
                                                                                              tl: {
                                                                                                hd: {
                                                                                                  detail: "Shaka\xe2\x80\x99s unique ability is Amabutho, which unlocks Corps and Army early (keep an eye out for a pattern) and gives each added combat strength. His agenda is Horn, Chest, Loins. That combination pushes him to form as many Corps and Armies as possible. Shaka is useful; He\xe2\x80\x99s a natural, combative leader who despises anyone who won\xe2\x80\x99t follow his orders and who can overwhelm enemies entirely through shocking numbers of Impi units. You will need to keep a watchful eye on your economy and war-weariness levels with the Zulu. The Impi, however, are much easier to manage, and you can rally them into fearsome armies affordably.Civilization VI can take a while to master. The complex layers and dense gameplay can be a learning curve for new players. By learning the basics of all of the characters, you are a step closer to finalizing your playing style. It\xe2\x80\x99s a significant advantage. Through this guide, you\xe2\x80\x99ll already recognize your strengths and weaknesses and your challengers and will be able to make sweeping power plays in no time.",
                                                                                                  name: "Zulu (Rise & Fall)",
                                                                                                  leaderName: "Shaka",
                                                                                                  perk: "Perk: Isibongo",
                                                                                                  unit: "Unit: Impi",
...
function generateCivList(number) {
  return Belt_List.take(Belt_List.shuffle(data), Math.imul(number, 3));
}

function getPlayerWithCiv(playerNames, civs) {
  if (!playerNames) {
    return /* [] */0;
  }
  if (!civs) {
  ...
  if (match$1) {
    return Belt_List.concat({
                ...
                tl: /* [] */0
              }, getPlayerWithCiv(playerNames.tl, match$1.tl));
  } else {
    return /* [] */0;
  }
}

function genPlayers(playerNames) {
  var randomCivs = generateCivList(Belt_List.length(playerNames));
  if (randomCivs !== undefined) {
    return getPlayerWithCiv(playerNames, randomCivs);
  } else {
    return /* [] */0;
  }
}
...
exports.data = data;
exports.generateCivList = generateCivList;
exports.getPlayerWithCiv = getPlayerWithCiv;
